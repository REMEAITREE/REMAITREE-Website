...
return(
 ...
 {/* <IconButton
        ...
        <ul>
          <li>
            <button   onClick={() => (window.location = "/find-the-doc")}>Find</button>
          </li>
          <li>
      ...
      <div className="nav2">
        <ul>
          <li>
            <button onClick={() => (window.location = "/services")}><MedicalServicesIcon/>Services</button>
          </li>
          <li>
          ...
          <li>
            <button  onClick={() => (window.location = "/auth/signin")}><LoginIcon/>Login</button>
          </li>
