            ...
            <div className={st.main}>
                ...
                <div className={st.rightbox}>
                    ...
                    {hover === 4 &&
                        <div className={st.chatbox}>
                            <div className={st.chatsec}>
                                {chatList && chatList.map(({ id, name, msg, sender_dr }) => {
                                    return (
                                        <>
                                            <Chatbox key={id} id={id} name={name} msg={msg} sender_dr={sender_dr}></Chatbox>
                                        </>
                                    )
                                })}
                            </div>
                            <Box className={st.entermsg}>
                                <Input placeholder='Enter a Message .....' onChange={(event) => setNew(event.target.value)} />
                                <button className={st.msgicon} onClick={() => addMsg(newmsg)}><BsFillSendFill></BsFillSendFill></button>
                            </Box>
                ...
                <div className={st.navbar}>
                    ...
                    <div className={st.navparent}>
                        ...
                        {hover === 4 ?
                            <div className={st.hoverborder_4t} onClick={() => changemode(4)}> <item className={st.item} id={st["i_4"]}><BsChatSquareText color='#7E8DF1' size="25px"></BsChatSquareText></item></div>
                            :
                            <div className={st.hoverborder_4} onClick={() => changemode(4)}> <item className={st.item} id={st["i_4"]}><BsChatSquareText color='#7E8DF1' size="25px"></BsChatSquareText></item></div>
                        }
